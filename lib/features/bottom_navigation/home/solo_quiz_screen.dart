...
class Quiz {
  ...
  Quiz(this.reward, this.entry, this.correct, this.percentage);
}

class SoloQuizScreen extends StatelessWidget {
  SoloQuizScreen({Key? key}) : super(key: key);
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          quizList[index].correct == '10'
                              ? s.correct_all_to_win
                              : '${quizList[index].correct}/10 ${s.correct_win}',
                          style:
